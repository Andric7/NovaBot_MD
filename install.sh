...
echo -e "\033[1;35m"
git clone https://github.com/Andric7/NovaBot-MD.git
...
menu_ayuda() {
	...
	case $opcion in
            01|1)
                am start -a android.intent.action.VIEW https://chat.whatsapp.com/ETl0rMbECLSEOFdkvQsfVH &>> /dev/null
